  ...
  'inline-flex items-center border-2 px-2 py-0.5 text-xs font-mono uppercase tracking-wider transition-all duration-100 focus:outline-none focus:ring-2 focus:ring-neon-cyan focus:ring-offset-2 focus:ring-offset-terminal-black',
  {
    variants: {
      variant: {
        ...
        pink: 'border-neon-pink bg-neon-pink/10 text-neon-pink shadow-[1px_1px_0_hsl(330_100%_60%)] hover:bg-neon-pink/20',
        // Category-specific variants
        development: 'border-cat-development bg-cat-development/10 text-cat-development',
        deployments: 'border-cat-deployments bg-cat-deployments/10 text-cat-deployments',
        infrastructure:
          'border-cat-infrastructure bg-cat-infrastructure/10 text-cat-infrastructure',
        issues: 'border-cat-issues bg-cat-issues/10 text-cat-issues',
        security: 'border-cat-security bg-cat-security/10 text-cat-security',
      },
    },
    defaultVariants: {
      variant: 'default',
