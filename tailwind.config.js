    ...
    extend: {
      ...
      keyframes: {
        ...
        "glow": {
          ...
          "50%": { boxShadow: "0 0 10px hsl(180 100% 50%), 0 0 20px hsl(180 100% 50%), 0 0 30px hsl(180 100% 50%)" },
        },
      ...
      textShadow: {
        'glow-cyan': '0 0 5px hsl(180 100% 50%), 0 0 10px hsl(180 100% 50%), 0 0 20px hsl(180 100% 50%)',
        'glow-magenta': '0 0 5px hsl(300 100% 50%), 0 0 10px hsl(300 100% 50%), 0 0 20px hsl(300 100% 50%)',
        'glow-green': '0 0 5px hsl(120 100% 50%), 0 0 10px hsl(120 100% 50%), 0 0 20px hsl(120 100% 50%)',
      },
    },
  },
